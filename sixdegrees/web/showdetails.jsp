...
<html>
							...
							-->
                                                        <ul>
                                                               ...
                                                               <li><a href="showdetails.jsp?name=<%=name%>"><%=d1%>'S WALL</a></li>
                                                                ...
                                                                <li><a href="showfriends.jsp?name=<%=name%>"><%=d1%>'S FRIENDS</a></li>
 ...
 <font face="Arial" size="+1.5">POST(Max 200 characters)</font>
    <textarea name="post" rows="1" cols="50" onkeyup="if (this.value.length >200) { alert('Character limit has been reached!'); this.value = this.value.substr(0,200); }" ></textarea>
