...
-->
<%@page import="com.sixdegrees.model.showresult"
...
<html>
	...
	<header><center>
								<h2 class="alt"><strong>SUGGESTIONS</strong></h2></center>
							</header>    
        <center>
  ...
  name =request.getParameter("name");
   ...
   rs=showresult.show(name,username);
    ...
    <tr>
      ...
      <td><a href="sendrequest?user=<%=s1%>">ADD</a></td>
   ...
   if(!flag)
       ...
       <br/>
                                                <br/>
                                                <br/>
            <font size="+2.0">SORRY! NO SUGGESTIONS</font>
            <%
}     
               %>
