...
<html>
	...
	<header><center>
								<h2 class="alt"><strong>OPTIONS</strong></h2></center>
							</header>    
        

                                	<center>
                                                <a href="tolerance.jsp"><font size="+2.0">EDIT TOLERANCE LEVEL</font></a>
                                                <br/>
                                                <br/>
                                                <br/>
                                                  <a href="changedefaultaction.jsp"><font size="+2.0">EDIT DEFAULT ACTION</font></a>
