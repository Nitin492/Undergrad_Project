<%-- 
    Document   : login
    Created on : 22 Feb, 2014, 9:24:06 PM
    Author     : Nitin
--%>
...
<html>
	...
	<body>
		...
		<div id="wrapper">
                    ...
                    <tr>
                    <td> <input type="text" name="id" class="button style3 scrolly scrolly-centered"></td>
                    <td><input type="password" name="pass"  class="button style3 scrolly scrolly-centered"></td>
