...
-->
<%@page import="com.sixdegrees.model.edushow"
...
<html>
	...
	<header><center>
								<h2 class="alt"><strong>EDUCATION DETAILS</strong></h2></center>
							</header>    
        
   <form action="edudetails">
<center>
        ...
        <td><input type="text" name="Iname" value="<%=s1%>"/></td>
          </tr>
              <tr>
        <td>YEAR</td>
