...
-->
 <%@page import="com.sixdegrees.model.showblockedposts"
...
<html>
  ...
  <header><center>
								<h2 class="alt"><strong>MY POSTS</strong></h2></center>
							</header>    
    <table cellspacing="1">
   ...
   System.out.println(name);
    PrintWriter P=response.getWriter();
      rs=showblockedposts.show(name);
             ...
             %>  
             <tr><td><font size="+2.0"><%=s1%>><%=s2%></font></td>
                 <td><%=s3%><a href="deleteblocked?message=<%=s3%>&sender=<%=s1%>&receiver=<%=s2%>">DELETE</a></td></tr>
