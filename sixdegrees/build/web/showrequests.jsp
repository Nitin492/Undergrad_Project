...
-->
 <%@page import="com.sixdegrees.model.showrequests"
...
<center>
<header><center>
								<h2 class="alt"><strong>REQUESTS</strong></h2></center>
							</header>                                                  <br/>
   ...
   rs=showrequests.show(name);
    ...
    <tr>
        ...
        <td><a href="addfriend?user=<%=s1%>">ADD</a></td>
        <td><a href="deleterequest?user=<%=s1%>">DELETE</a></td>
   ...
   if(!flag)
       ...
       <br/>
                                                <br/>
                                                <br/>
            <font size="+2.0">SORRY! NO REQUESTS</font>
            <%
}     
               %>
